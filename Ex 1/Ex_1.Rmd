...
# Excess returns
asset_excess  <- cbind(data[[asset]] - data$USTB3M)
market_excess <- cbind(data$SANDP - data$USTB3M)

asset_excess <- log(asset_excess)
market_excess <- log(market_excess)
...
plot1 <- ggplot(df, aes(x = asset_excess)) +
...
plot2 <- ggplot(df, aes(x = market_excess)) +
  geom_histogram(aes(y = ..density..), bins = 40, fill = "grey") +
