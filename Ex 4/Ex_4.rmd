...
pacman::p_load(readxl,tidyverse, moments, fitdistrplus, copula,evd, VineCopula, tseries)

packages <- c("readxl","tidyverse", "moments", "fitdistrplus", "copula","evd", "VineCopula", "tseries")
...
gev_AUT <- fgev(bonds$AUT_spread)
gev_SPA <- fgev(bonds$SPA_spread)
